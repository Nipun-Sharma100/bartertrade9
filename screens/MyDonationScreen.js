...
export default class MyDonationScreen extends Component {
   ...
   sendBook=(bookDetails)=>{
     if(bookDetails.request_status === "Item exchanged"){
     ...
     .then((snapshot)=>{
       snapshot.forEach((doc) => {
         ...
         if(requestStatus === "Item exchanged"){
           message = this.state.donorName + " exchanged you the item"
         }else{
       ...
       rightElement={
           ...
           >
             <Text style={{color:'#ffff'}}>{
               item.request_status === "Item exchangedt" ? "Item exchanged" : "Exchange item"
             }</Text>
           </TouchableOpacity>
         }
       bottomDivider
